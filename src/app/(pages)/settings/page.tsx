          ...
          <div className="">
            <Card className="grid grid-cols-1 md:grid-cols-2 p-4">
              <CardContent>
                ...
                <CardDescription className="">
                  Choisissez votre pays de navigation pour personnaliser votre
                  expérience.
                </CardDescription>
            ...
            <Card className="grid grid-cols-1 md:grid-cols-2 p-4">
              <CardContent>
                ...
                <CardDescription className="mt-2 md:mt-5">
                  N’hésitez pas à contacter{" "}
                  <Link href={"contact"} className=" decoration-green-500">
              ...
              <CardFooter>
                <Button className="shadow-md" variant={"destructive"}>

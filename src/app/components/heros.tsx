...
const Heros = () => {
  return ( 
    <header className='  w-full bg-[#7a3ebe] mb-5'>
      <div className="container mx-auto flex flex-col my-auto h-full justify-center items-center gap-4 p-3 md:p-5">
        ...
        <div className="search-box w-full justify-center items-center flex">
          ...
          <Button className='inline-flex font-bold items-center gap-2 border h-[4.25rem]  px-2 rounded-r-md rounded-l-none bg-[#309689]'>
            <Search className=''/>
            Trouver un job
          </Button>
        </div>
